...
export async function generateMetadata(props: {
  ...
  return {
    ...
    openGraph: {
      ...
      title: blog.title,
      description: blog.summary,
      url: `https://www.shivshaktiwaterequipment.com/blog/${resolvedParams.slug}`,
      images: [
        {
          url: imageUrl,
          alt: blog.title,
...
export default async function BlogPage(props: {
  ...
  const blogSchema = {
    ...
    "@type": "BlogPosting",
    "headline": blog.title,
    "image": `https://www.shivshaktiwaterequipment.com${blog.image}`,
    ...
    "publisher": {
      ...
      "logo": {
        "@type": "ImageObject",
        "url": "https://www.shivshaktiwaterequipment.com/assets/images/shiv_shakti_logo.png"
      }
    },
    "description": blog.summary
  };
    ...
    "itemListElement": [
      {
        ...
        "position": 1,
        "name": "Home",
        "item": "https://www.shivshaktiwaterequipment.com"
      },
      {
        "@type": "ListItem",
        "position": 2,
        "name": "Blog",
        "item": "https://www.shivshaktiwaterequipment.com/blog"
      },
      {
        "@type": "ListItem",
        "position": 3,
        "name": blog.title,
        "item": `https://www.shivshaktiwaterequipment.com/blog/${resolvedParams.slug}`
      }
    ]
  };
