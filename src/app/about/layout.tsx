...
export const metadata: Metadata = {
  ...
  description: "Established in 1998, SHIV SHAKTI WATER EQUIPMENT PVT. LTD. is a premier B2B manufacturer & global exporter of mineral water bottling and liquid packaging plants.",
  alternates: {
